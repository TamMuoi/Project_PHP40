<?php 
 ...
 <div class="template-cart">
              ...
              <table class="table table-cart">
                ...
                <?php if(isset($_SESSION["cart"])): ?>
                  ...
                  <tr>
                    ...
                    <td><input type="number" id="qaty" min="1" class="input-control" value="<?php echo $product["number"]; ?>" name="product_<?php echo $product["id"]; ?>" required="Không thể để trống"></td>
                    <td><p><b><?php echo number_format($product["number"]*$product["price"]); ?>₫</b></p></td>
                    <td>
                      <a href="index.php?controller=cart&action=delete&id=<?php echo $product["id"]; ?>" data-id="2479395">Xóa</a>
                    </td>
          ...
          <!-- goi ham cart_total() trong cartModel -->
