...
<body class="single single-product postid-70 woocommerce woocommerce-page with_aside aside_right layout-full-width button-stroke header-stack header-center minimalist-header sticky-header sticky-white subheader-title-left footer-copy-center">
       ...
       <!-- End Main Content -->
                ...
                <div class="sidebar four columns">
                    <div class="widget-area clearfix ">
                        ...
                        <!-- End -->
                       <?php 
                              include "controllers/frontend/hotproductController.php";
            ...
            <div class="footer_copy">
                <div class="container">
                    <div class="column one">
                        ...
                        <!-- Copyrights -->
                        <div class="copyright">
                            &copy; 2019 BeStore - BeTheme. All Rights Reserved. <a target="_blank" rel="nofollow" href="http://bit.ly/1M6lijQ">BeantownThemes</a> </div>
    ...
    <script>
        ...
        jQuery(window).load(function() {
            ...
            if (retina) {
                ...
                stickyEl.attr("src", "images/retina_store_s.html").width(stickyLogoW).height(stickyLogoH);
            }
        });
        //]]>
    </script>
